(function(root, factory) {
  ...
  VMasker.toMoney = function(value, opts) {
    ...
    const includedZeroCents= fillWithZeroCount ? Array(fillWithZeroCount).fill(0).join('') : ''
    const includeDecimals = value.includes('.') ? `${decimalSeparator}${decimals}${includedZeroCents}` : (
        fillWithZeroCount ? decimalSeparator + includedZeroCents: ""
    );
